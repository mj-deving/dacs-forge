...
export const EXPECTED_ATOMIC_WRITE_SITES: Readonly<Record<string, ExpectedAtomicWriteSite>> = Object.freeze({
  ...
  "bundle.put-anchor": expected("bundle-finalisation", "FixtureBundleStore.#finaliseWithinTransaction", "immediate", "fixture-bundle.ts:335"),
  "bundle.put-copy": expected("bundle-finalisation", "FixtureBundleStore.#finaliseWithinTransaction", "immediate", "fixture-bundle.ts:348"),
  "bundle.finalise-lifecycle": expected("bundle-finalisation", "FixtureBundleStore.#finaliseWithinTransaction", "immediate", "fixture-bundle.ts:368"),
