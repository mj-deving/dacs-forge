...
export const EXPECTED_ATOMIC_WRITE_SITES: Readonly<Record<string, ExpectedAtomicWriteSite>> = Object.freeze({
  ...
  "party-authority.cleanup-challenges": expected("party-challenge-cleanup", "PartyAuthorityLifecycle.allocatePartyChallenge", "immediate", "party-authority-lifecycle.ts:301"),
  "party-authority.allocate-challenge": expected("party-challenge-allocation", "PartyAuthorityLifecycle.allocatePartyChallenge", "immediate", "party-authority-lifecycle.ts:365"),
  "party-authority.cleanup-preparations": expected("party-capability-preparation-cleanup", "PartyAuthorityLifecycle.prepareCapabilityReplacement", "immediate", "party-authority-lifecycle.ts:425"),
  "party-authority.prepare-capability": expected("party-capability-preparation", "PartyAuthorityLifecycle.prepareCapabilityReplacement", "immediate", "party-authority-lifecycle.ts:444"),
  "party-authority.consume-preparation": expected("party-capability-consumption", "PartyAuthorityLifecycle.#consumePrepared", "immediate", "party-authority-lifecycle.ts:830"),
  "party-authority.consume-challenge": expected("party-capability-exchange", "PartyAuthorityLifecycle.#exchangeTransaction", "immediate", "party-authority-lifecycle.ts:786"),
  "party-authority.reclaim-party-capabilities": expected("party-capability-reclamation", "PartyAuthorityLifecycle.#insertGrantRow", "immediate", "party-authority-lifecycle.ts:859"),
  "party-authority.issue-capability": expected("party-capability-issuance", "PartyAuthorityLifecycle.#insertGrantRow", "immediate", "party-authority-lifecycle.ts:887"),
  "party-authority.revoke-capability": expected("party-capability-revocation", "PartyAuthorityLifecycle.#revokeDigest", "immediate", "party-authority-lifecycle.ts:911"),
  "party-authority.apply-amendment": expected("party-authority-amendment", "PartyAuthorityLifecycle.applySessionAmendment", "immediate", "party-authority-lifecycle.ts:697"),
  "party-authority.invalidate-amended-capabilities": expected("party-authority-amendment", "PartyAuthorityLifecycle.applySessionAmendment", "immediate", "party-authority-lifecycle.ts:713"),
  "party-authority.invalidate-amended-challenges": expected("party-authority-amendment", "PartyAuthorityLifecycle.applySessionAmendment", "immediate", "party-authority-lifecycle.ts:718"),
