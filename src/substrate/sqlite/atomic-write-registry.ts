...
const SITE_ROWS = [
  ...
  ["turnkey-signing.prepare", "turnkey-signing-intent", "insert", "TurnkeySigningIntentStore.prepare", "src/live/turnkey-signing-activity.ts", "turnkey_signing_intents"],
  ["turnkey-signing.mark-submitting", "turnkey-signing-submission", "update", "TurnkeySigningIntentStore.markSubmitting", "src/live/turnkey-signing-activity.ts", "turnkey_signing_intents"],
  ["turnkey-signing.observe-activity", "turnkey-signing-activity-observation", "update", "TurnkeySigningIntentStore.observeActivity", "src/live/turnkey-signing-activity.ts", "turnkey_signing_intents"],
  ["turnkey-signing.persist-signature", "turnkey-signing-envelope-persistence", "update", "TurnkeySigningIntentStore.persistSignature", "src/live/turnkey-signing-activity.ts", "turnkey_signing_intents"],
